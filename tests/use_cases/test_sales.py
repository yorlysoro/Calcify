...
from infrastructure.database.models import ProductModel, TransactionModel
...
class TestRegisterSale:
    ...
    def test_does_not_create_transaction_on_failure(self, db_session: Session) -> None:
        ...
        product = seed_product(db_session, stock=10)
        tx_count_before = db_session.query(TransactionModel).count()
        ...
        tx_count_after = db_session.query(TransactionModel).count()
